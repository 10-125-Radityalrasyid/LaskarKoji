...
class Pendekar(BaseLogic):
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        if props.diamonds >= props.inventory_size - 1:
            ...
            if nearest_teleporter and distance_to_diamond > calc_distance(paired_teleporter, highest_density_diamond.position) + calc_distance(bot_position, nearest_teleporter):
                self.goal_position = nearest_teleporter
            else:
